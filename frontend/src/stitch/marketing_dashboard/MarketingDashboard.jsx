      ...
      <div className="p-8 space-y-8">
        ...
        <div className="flex items-start justify-between flex-wrap gap-4">
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 rounded-lg border border-amber-500/30 bg-amber-500/10 text-amber-400 text-xs font-bold uppercase tracking-widest hover:bg-amber-500/20 transition-all"
          >
        ...
        <div className="flex items-start gap-4 p-4 rounded-xl bg-amber-500/5 border border-amber-500/20">
          ...
          <div>
            ...
            <p className="text-slate-500 text-xs">
              ...
              contacta a tu gestor de campañas a través de{' '}
