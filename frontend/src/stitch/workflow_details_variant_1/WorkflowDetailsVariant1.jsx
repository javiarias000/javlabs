...
export default function WorkflowDetailsVariant1() {
  return (
    <>
      <header className="flex items-center justify-between border-b border-slate-800 px-8 py-4 bg-background-dark">
...
<h4 className="font-michroma text-sm text-slate-100 mb-1">Nuevo Lead</h4>
...
<h4 className="font-michroma text-sm text-slate-100 mb-1">Región: LATAM</h4>
...
<h4 className="font-michroma text-sm text-slate-100 mb-1">Crear en Salesforce</h4>
...
<p className="font-michroma text-2xl text-slate-100">12,842</p>
...
<p className="font-michroma text-2xl text-slate-100">99.8%</p>
...
<p className="font-michroma text-2xl text-slate-100">420h</p>
...
<tr className="border-b border-slate-900 hover:bg-slate-50 dark:hover:bg-slate-900/30 transition-colors">
